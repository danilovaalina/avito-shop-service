...
type ClientInterface interface {
	...
	// PostApiBuyWithBody request with any body
	PostApiBuyWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostApiBuy(ctx context.Context, body PostApiBuyJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PostApiBuyWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostApiBuyRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostApiBuy(ctx context.Context, body PostApiBuyJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostApiBuyRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostApiBuyRequest calls the generic PostApiBuy builder with application/json body
func NewPostApiBuyRequest(server string, body PostApiBuyJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostApiBuyRequestWithBody(server, "application/json", bodyReader)
}

// NewPostApiBuyRequestWithBody generates requests for PostApiBuy with any type of body
func NewPostApiBuyRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/buy")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostApiBuyWithBodyWithResponse request with any body
	PostApiBuyWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostApiBuyResponse, error)

	PostApiBuyWithResponse(ctx context.Context, body PostApiBuyJSONRequestBody, reqEditors ...RequestEditorFn) (*PostApiBuyResponse, error)
...
type PostApiBuyResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *ErrorResponse
	JSON401      *ErrorResponse
...
// Status returns HTTPResponse.Status
func (r PostApiBuyResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostApiBuyResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PostApiBuyWithBodyWithResponse request with arbitrary body returning *PostApiBuyResponse
func (c *ClientWithResponses) PostApiBuyWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostApiBuyResponse, error) {
	rsp, err := c.PostApiBuyWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostApiBuyResponse(rsp)
}

func (c *ClientWithResponses) PostApiBuyWithResponse(ctx context.Context, body PostApiBuyJSONRequestBody, reqEditors ...RequestEditorFn) (*PostApiBuyResponse, error) {
	rsp, err := c.PostApiBuy(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostApiBuyResponse(rsp)
...
// ParsePostApiBuyResponse parses an HTTP response from a PostApiBuyWithResponse call
func ParsePostApiBuyResponse(rsp *http.Response) (*PostApiBuyResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
